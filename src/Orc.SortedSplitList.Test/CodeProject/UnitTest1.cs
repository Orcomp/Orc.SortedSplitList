...
namespace Orc.SortedSplitList.Test
{
	...
	public class UnitTest1
	{
		...
		{
			var sortedSplitListSortedById = GetSortedSplitListSortedById();
			var index = sortedSplitListSortedById.BinarySearch(new TestObject {Id = 2});
		...
		{
			var sortedSplitListSortedById = GetSortedSplitListSortedById();
			var index = sortedSplitListSortedById.BinarySearch(new TestObject {Id = 8});
		...
		{
			var sortedSplitListSortedById = GetSortedSplitListSortedById();
			var index = sortedSplitListSortedById.BinarySearch(new TestObject {Id = 0});
			Assert.AreEqual(-1, index);
		}
